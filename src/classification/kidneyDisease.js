...
export {getClassification, getPercentageChange, sortByDate, getPercentageChanges, getDataWithPercentageChanged, getDataWithCriticalPercentageChanged, getCriticalData} ;